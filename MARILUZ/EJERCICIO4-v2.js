...
// Para subir archivo 
const archivoExcel = path.join(__dirname, 'Emails','Emails.xlsx'); // Esto puede que no se necesite si el archivo se sube desde UI
const emailsExcel = leerExcel(archivoExcel);

// Para subir correos manualmente
let emailsArray = [];
const addEmail = (email) => emailsArray.push(email);
...
sendMassiveEmail(subject, content, emailsExcel);
