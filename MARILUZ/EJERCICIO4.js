/**
 * Crear una app que envíe correo masivo de tal manera que permita enviar miles de
    correos al mismo tiempo. Como sugerencia puede usar la librería de Nodejs llamada
    Nodemailer
 */
    ...
    let emails = [
        'mcg200557@gmail.com',
        'sammyamigos.sa@gmail.com',
        'calderon.mariluz.8892@eam.edu.co',
        'cinesoft36@gmail.com',
        'gestionpro.soporte@gmail.com',
    ];
    ...
    async function sendMassiveEmail(subject, content) {
    ...
    sendMassiveEmail(subject, content);
